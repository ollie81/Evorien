...
/**
 * Builds the OpenAI model Evorien AI calls, reading OPENAI_API_KEY and AI_MODEL
...
export function getAiModel() {
  ...
  if (!apiKey) {
    throw new Error(
      "OPENAI_API_KEY is not set. Add it as a server-side environment variable (see .env.example) before using Evorien AI."
    );
  }
